function addHeader() {
    ...
    links.innerHTML += "<a href=\"http://www.samuelsharp.com\"><img class=\"footer\" src=\"https://league-central.github.io/curriculum/img/leagueOversized.jpeg\" alt=\"league-logo\" title=\"League Website\" style=\"width:90px;height:100px; vertical-align: top;\"></a>";
    links.innerHTML += "</span>&nbsp;&nbsp;<span>";
    links.innerHTML += "<a href=\"http://samuelsharp.com\"><h1>S</h1></a>";
    links.innerHTML += "</span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span>";
...
function addFooter() {
    ...
    footer.innerHTML += "<span style=\"position:absolute;bottom:20px;font-weight: bold;\">Original code by: <a href=\"http://www.jointheleague.org\">The League of Amazing Programmers</a></span>";
